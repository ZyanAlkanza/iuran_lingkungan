...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url('assets/')?>css/adminPengeluaran_tambah.css" />
  ...
  <body>
    <div class="halaman">
        <!-- Konten -->
        <form method="POST" action="<?php echo base_url('adminPengeluaran/tambahdata')?>" enctype="multipart/form-data">
            ...
            <div class="kolom">
                ...
                <!-- <div class="form-group"> -->
                  ...
                  <input type="text" pattern="[A-Za-z\s0-9]*" class="form-control" id="nama_pengeluaran" aria-describedby="emailHelp" name="nama_pengeluaran" autocomplete="off" required>
                ...
                <!-- <div class="form-group"> -->
                  ...
                  <div class="input-group mb-2">
                      ...
                      <input type="number" pattern="[0-9]*" class="form-control" id="biaya_pengeluaran" placeholder="100000"  name="biaya_pengeluaran" autocomplete="off" required>
                  </div>
                ...
                <div class="subKolom">
                  <div class="kolom-kiri">
                    ...
                    <input type="date" class="form-control" id="tanggal_pengeluaran" aria-describedby="emailHelp" name="tanggal_pengeluaran" required>
                  ...
                  <div class="kolom-kanan">
                    ...
                    <input type="file" class="form-control" id="bukti_pengeluaran" aria-describedby="emailHelp" name="bukti_pengeluaran" required>
                ...
                <!-- <div class="form-group"> -->
                  ...
                  <textarea class="form-control" id="keterangan_pengeluaran" name="keterangan_pengeluaran" maxlength="300"></textarea>
            ...
            <button type="submit" class="btn btn-primary submit" name="submit">Tambah Pengeluaran</button>
        </form>
