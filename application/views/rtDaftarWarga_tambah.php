...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url('assets/')?>css/rtDaftarWarga_tambah.css" />
  ...
  <body>
    <div class="halaman">
        ...
        <form method="POST" action="<?php echo base_url('rtDaftarWarga/tambahdata')?>" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary submit" name="submit">Tambah Warga</button>
        </form>
