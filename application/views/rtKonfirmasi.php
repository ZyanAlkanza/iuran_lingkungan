...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url('assets/')?>css/rtKonfirmasi.css" />
    ...
    <div class="halaman">
      ...
      <div class="konten">
        <div class="judul">
          ...
          <form method="POST" action="<?php echo base_url('rtKonfirmasi/tambahdata')?>" enctype="multipart/form-data">
