        ...
        <form method="POST" action="<?php echo base_url('rwDaftarRt/editdata')?>" enctype="multipart/form-data">
            <h1>Edit Profil Ketua RT</h1>
              ...
              <?php foreach ($warga as $wg) : ?>
                ...
                <input type="text" pattern="[A-Za-z0-9\s]*" class="form-control" id="nama_warga" aria-describedby="emailHelp" name="nama_warga" value="<?php echo $wg->nama_warga?>" required autocomplete="off">
