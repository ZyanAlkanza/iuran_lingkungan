...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url('assets/')?>css/rtDaftarWarga_edit.css" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url('assets/')?>/img/favicon.ico">

    <title>Edit Profil Warga</title>
  </head>
  <body>
    <div class="halaman">
        <!-- Konten -->
        <form method="POST" action="<?php echo base_url('rtDaftarWarga/editdata')?>" enctype="multipart/form-data">
            <h1>Edit Profil Warga</h1>
