...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url('assets/')?>css/rtDaftarPetugas_edit.css" />
  ...
  <body>
    <div class="halaman">
        <!-- Konten -->
        <form method="POST" action="<?php echo base_url('rtDaftarPetugas/editdata')?>" enctype="multipart/form-data">
            <h1>Edit Profil Petugas</h1>
              ...
              <?php foreach ($warga as $wg) : ?>
                ...
                <input type="text" pattern="[A-Za-z\s0-9]*" class="form-control" id="nama_warga" aria-describedby="emailHelp" name="nama_warga" value="<?php echo $wg->nama_warga?>" required autocomplete="off">
