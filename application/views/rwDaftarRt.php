...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url('assets/')?>css/rwDaftarRt.css" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url('assets/')?>/img/favicon.ico">

    <title>Daftar Ketua RT</title>
  </head>
  <body>
    <div class="halaman">
      <div class="menu">
      ...
      <div class="konten">
        <div class="judul">
          <h1>Daftar Ketua RT</h1>
          <div class="tombol">
            <a href="<?php echo base_url('rwDaftarRt/tambah')?>">
