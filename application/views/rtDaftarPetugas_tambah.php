...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url('assets/')?>css/rtDaftarPetugas_tambah.css" />
  ...
  <body>
    <div class="halaman">
        <!-- Konten -->
        <form method="POST" action="<?php echo base_url('rtDaftarPetugas/tambahdata')?>" enctype="multipart/form-data">
            <h1>Tambah Petugas</h1>

            
                <label for="nama_warga">Nama Petugas <span class="text-danger">*</span></label>
                <input type="text" pattern="[A-Za-z\s0-9]*" class="form-control" id="nama_warga" aria-describedby="emailHelp" name="nama_warga" autocomplete="off">
            ...
            <button type="submit" class="btn btn-primary submit" name="submit">Tambah Petugas</button>
        </form>
