...
(72, 8, 'bukti-azharee14.png', '', 3),
(73, 8, 'bukti-azharee31.png', '', 0),
(75, 8, 'bukti-azharee32.png', '', 0),
(76, 8, 'bukti-azharee61.png', '', 0),
(77, 8, 'bukti-azharee62.png', '', 3),
(78, 8, 'bukti-azharee62.png', '', 0),
(79, 0, 'bukti-azharee64.png', '', 3);
...
CREATE TABLE `pengeluaran` (
  ...
  `biaya_pengeluaran` varchar(10) NOT NULL,
...
INSERT INTO `pengeluaran` (`id_pengeluaran`, `nama_pengeluaran`, `biaya_pengeluaran`, `tanggal_pengeluaran`, `bukti_pengeluaran`, `keterangan_pengeluaran`) VALUES
(1, 'Gaji Satpam', '2000000', '2023-07-31', 'bukti.jpg', ''),
(3, 'Lomba 17 Agustus', '100000', '2023-08-17', 'bukti3.jpg', '');
...
CREATE TABLE `transaksi` (
  ...
  `pembayaran_bulan` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(77, 2, 'az', '2023-04-01', 'April'),
(78, 2, 'az', '2023-08-05', 'Mei'),
(79, 2, 'az', '2023-08-05', 'Juni');
